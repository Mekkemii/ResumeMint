...
Шаг 1 — Анализ резюме и определение уровня кандидата
...
Определение уровня кандидата по критериям:
- Junior (0-2 года опыта): базовые знания в области, выполнение типовых задач под контролем, ориентация на базовые навыки, выполнение задач по плану, проявление инициативы, нуждается в наставничестве
- Middle (2-5 лет опыта): уверенная работа в области, умение оптимизировать решения, сочетание теории и практики, участие в планировании и помощь коллегам, ответственность за отдельные задачи, самостоятельное выполнение большинства работ
- Senior (5-8 лет опыта): проектирование решений, умение решать сложные задачи, глубокое понимание процессов и методологий, управление процессами и приоритетами, ведение проектов до завершения и наставничество команды
- Lead/Expert (8+ лет опыта): глубокие знания в области и руководство командами, ответственность за успешное выполнение проектов, координация работы команды, принятие стратегических решений, взаимодействие с клиентами и заинтересованными сторонами

Формат оценки уровня: [Уровень] - [краткое обоснование с указанием ключевых факторов: опыт работы, профессиональные навыки, самостоятельность, сложность задач, уровень ответственности]
...
- Недочеты ⚠️
- Что добавить 🔧
- Определенный уровень кандидата с обоснованием
